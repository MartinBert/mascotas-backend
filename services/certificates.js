...
const private_key = fs.readFileSync(path.join(__dirname + '/certificates/certificate.crt'), {encoding: 'utf8'});
const public_key = fs.readFileSync(path.join(__dirname + '/certificates/key.key'), {encoding: 'utf8'});
